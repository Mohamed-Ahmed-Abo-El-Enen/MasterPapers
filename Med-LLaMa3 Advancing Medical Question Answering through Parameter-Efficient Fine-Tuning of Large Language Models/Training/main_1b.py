...
class TrainingConfig:
    ...
    base_model_name: str = "meta-llama/Llama-3.2-1B-Instruct"  # Will be extracted from PEFT config
    ...
    # API Keys
    wandb_project: str = "Llama-3.2-1B-Instruct-Medical-Finetune-v5"
    wandb_api_key: str = "2be7c86a28a2bcbeccdfa66844abfdd19b9bdabf"
    hf_token: str = "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"
    hub_model_id: str = "Llama-3.2-1B-Instruct-Medical-Finetune-v5"
