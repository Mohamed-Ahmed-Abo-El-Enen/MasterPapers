...
class TrainingConfig:
    ...
    model_name: str = "./Llama-3.1-8B-Instruct-Medical-Finetune-v4"# "meta-llama/Llama-3.1-8B-Instruct"
    base_model_name: str = "meta-llama/Llama-3.1-8B-Instruct"  # Will be extracted from PEFT config
